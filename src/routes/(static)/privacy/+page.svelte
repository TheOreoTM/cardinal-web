	...
	<div class="flex grow flex-col lg:items-center p-7">
		<div class="flex grow flex-col gap-4">
			...
			<div class="flex flex-col gap-4">
				<p>This policy is effective as of February 02, 2024 and was last updated on February 02, 2024.</p>
				<p>
					Your privacy is important to us. It is Cardinal Bot's policy to respect your privacy and comply with
					any applicable law and regulation regarding any personal information we may collect about you,
					including across our website, <a class="anchor" href="/">https://cardinal.oreotm.xyz</a>, and other
			...
			<LegalSection title="Information from Discord">
				<p>
					...
					participating in any of our services, and any information automatically sent by your devices in the
					course of accessing our products and services. Information including, but not limited to:
				</p>
				...
				<LegalSubsection title="User Message Content Tracking">
					<p>
						...
						user messages. However, for statistical purposes, we do track the volume of messages sent by users
						within a server. This data is used solely for server activity analytics and does not involve
						storing the actual content of messages.
					</p>
				</LegalSubsection>
			</LegalSection>
			...
			<LegalSection title="Information from use of cardinal.oreotm.xyz">
				...
				<LegalSubsection title={"Children's Privacy"}>
					<p>
						...
						not knowingly collect personal information about children under 13. In the case we discover that a
				...
				<LegalSubsection title="Disclosure of Personal Information to Third Parties">
					...
					<p>It is important to note that we do not share or sell any of your data to third-parties.</p>
				</LegalSubsection>
			...
			<LegalSection title="Changes to This Policy">
				<p>
					The contents of this privacy policy may occasionally be updated. It is recommended to check this
					periodically in case of any changes. Any changes to this policy will be made known at the top of the
					page.
				</p>
			</LegalSection>
			<LegalSection title="Contact Us">
				<p>
					For any questions or concerns regarding your privacy, you may contact us using the following links:
				</p>
				<p class="flex flex-col">
					<a class="anchor" href="mailto: support@oreotm.xyz">support@oreotm.xyz</a>
					<a class="anchor" href={PathNames.Discord}>Support server</a>
				</p>
			</LegalSection>
		</div>
	</div>
