	...
	<div class="flex grow flex-col lg:items-center p-7">
		<div class="flex grow flex-col gap-4">
			...
			<div class="flex flex-col gap-4">
				<p>
					This policy is effective as of February 02, 2024 and was last updated
					on February 02, 2024.
				</p>
				<p>
					Your privacy is important to us. It is Cardinal Bot's policy to
					...
					across our website, <a class="anchor" href="/"
						>https://cardinal.oreotm.xyz</a
			...
			<LegalSection title="Information from Discord">
				<p>
					...
					services, and any information automatically sent by your devices in
					the course of accessing our products and services. Information
			...
			<LegalSection title="Information from use of cardinal.oreotm.xyz">
				...
				>
					...
					<p>
						It is important to note that we do not share or sell any of your
			...
			<LegalSection title="Contact Us">
				<p>
					...
					us using the following links:
				</p>
				<p class="flex flex-col">
					<a class="anchor" href="mailto: support@oreotm.xyz"
						>support@oreotm.xyz</a
					>
